...
from model.criss_cross_transformer import TransformerEncoderLayer, TransformerEncoder
    ...
    def __init__(self, in_dim, out_dim, d_model, seq_len):
        ...
        self.proj_in = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=25, kernel_size=(1, 49),
                      stride=(1, 25), padding=(0, 24)),
            nn.GroupNorm(5, 25),
            nn.GELU(),
            nn.Conv2d(in_channels=25, out_channels=25, kernel_size=(1, 3),
